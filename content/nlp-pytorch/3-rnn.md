...
> 但如果要理解一句话、一段话呢？比如：<br>
> “我昨天去了公园……然后我看到了一只很像你家那只的狗。”<br>
> 要理解最后一句，模型必须记住“我去了公园”这件事。<br>
> 今天，我们就来教模型**如何记忆**——这就是 **循环神经网络（RNN）** 的核心能力。

## 一句话理解 RNN

> **RNN 就像一个会写读书笔记的学生。**<br>
> 每读一个词，他就翻看之前的笔记，结合新词，写下新的理解。<br>
...
> **“唰！”——所有句子的第一个词同时处理完毕。**<br>
> **“唰！”——所有句子的第二个词同时处理完毕。**<br>
> ……
