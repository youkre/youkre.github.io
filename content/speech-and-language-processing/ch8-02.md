...
![**图 8.6** Transformer 块的架构，展示了 **残差流**。本图展示的是 **前置归一化**（prenorm）版本的架构，即层归一化发生在注意力层和前馈层之前，而非之后。](/images/speech-and-language-processing/slp-fig-8-6.png)
...
![**图 8.7** 一个注意力头可以将词元 A 的残差流中的信息“移动”到词元 B 的残差流中。](/images/speech-and-language-processing/slp-fig-8-7.png)
