...
![**图 7.4** 计算在给定前缀后，`positive` 与 `negative` 两个词元出现的概率。](/images/speech-and-language-processing/slp-fig-7-4.png)
...
::caption:: **图 7.5** 通过计算问题前缀之后各词元的概率来回答问题；在此例中，正确词元 `Charles` 拥有最高概率。