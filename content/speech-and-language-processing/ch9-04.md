...
![**图 9.9** 基于双向 Transformer 编码器的序列分类。`[CLS]` 标记的输出向量作为简单分类器的输入。](/images/speech-and-language-processing/slp-fig-9-9.png)
...
- `Neutral`（中立）<br>
  a: Jon walked back to the town to the smithy.<br>
  b: Jon traveled back to his hometown.

- `Contradicts`（矛盾）<br>
  a: Tourist Information offices can be very helpful.<br>
